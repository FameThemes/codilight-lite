		...
		<div class="container">
			<div class="topbar-left pull-left">
				<nav id="site-navigation" class="main-navigation" role="navigation">
					...
					<span class="nav-toggle"><a href="#0" id="nav-toggle"><?php esc_attr_e( 'Menu', 'codilight-lite' ); ?><span></span></a></span>
					<ul class="ft-menu">
			...
			<div class="topbar-right pull-right">
				<ul class="topbar-elements">
					...
					<li class="topbar-search">
						<a href="javascript:void(0)"><i class="search-icon fa fa-search"></i><span><?php esc_attr_e( 'Search', 'codilight-lite' ); ?></span></a>
