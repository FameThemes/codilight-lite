...
function codilight_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Codilight_Lite_Misc_Control( $wp_customize, 'codilight_lite_color_message',
		array(
			'section'     => 'colors',
			'type'        => 'custom_message',
			'description' => wp_kses( __( 'Check out <a target="_blank" href="https://www.famethemes.com/themes/codilight-lite?utm_source=codilight_lite_customizer&utm_medium=text_link&utm_campaign=codilight_lite#compare">Codilight Premium</a> version for full control over site color styling!', 'codilight-lite' ) )
		)
	));
